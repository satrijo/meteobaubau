                ...
                <div class="card-body ">
                    ...
                    <form action="{{route('category.update', $data->id)}}" method="post">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" name="name" placeholder="Nama kategori" value="{{$data->name}}" class="form-control" required>
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="deskripsi" placeholder="Deskripsi (Optional)" rows="10" class="d-block w-100 form-control">{{$data->deskripsi}}</textarea>
                        </div>
