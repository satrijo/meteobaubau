            ...
            <div class="col">
                <article>
                    <div class="article__title text-center">
                        <h1 class="h2">Tugas dan Fungsi</h1> <span>--------------</span>
                    </div>
                    <div class="article__body">
                        <p>BMKG mempunyai status sebuah Lembaga Pemerintah Non Departemen (LPND), dipimpin oleh seorang Kepala Badan.
                        <h4>Tugas</h4>BMKG mempunyai tugas : melaksanakan tugas pemerintahan di bidang Meteorologi, Klimatologi, Kualitas Udara dan Geofisika sesuai dengan ketentuan perundang-undangan yang berlaku.<h4>Fungsi</h4>Dalam melaksanakan tugas sebagaimana dimaksud di atas, Badan Meteorologi Klimatologi dan Geofisika menyelenggarakan fungsi :
                        <ol>
